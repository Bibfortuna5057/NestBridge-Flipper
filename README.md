...
ESP32 development board with WiFi and BLE support running MicroPython — tested on Lonely Binary ESP32-S3
...
Open main.py and fill in your WiFi credentials and NLE API key
Save main.py to the device — it runs automatically on boot
Plug into any USB charger

Flipper
Install ufbt
Clone this repo
Run ufbt in the project directory
Copy dist/nest_bridge.fap to your Flipper SD card under apps/
...
Open NestBridge on the Flipper
Select a command from the menu
Press OK
Flipper vibrates when the packet is sent
Notes
